...
package lib.autoNavigation.trajectory.constraint;
 ...
 * limit.
 */
public class OmniMecanumDriveKinematicsConstraint implements OmniTrajectoryConstraint {
     ...
     */
    public OmniMecanumDriveKinematicsConstraint(
    ...
    public double getMaxVelocityMetersPerSecond(
        ...
        ChassisSpeeds chassisSpeeds = new ChassisSpeeds(xdVelocity, ydVelocity, velocityMetersPerSecond * rotationRadPerMeter);
